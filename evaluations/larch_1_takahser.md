...
- [x] in general, it would be good if all the dialoges that contain a form would support the option to submit the form by pressing the _enter_ key. To support that, you can work with html `<form>`s. => [issue](https://github.com/Zeeve-App/larch/issues/138) created

### Documentation feedback

- [x] ~~It would be nice if there was a way to navigate the docs more easily. For example, you could add an _index.md_ file to each directory and add links (and some useful content) to each of them.~~ => fixed
